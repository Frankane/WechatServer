...
namespace WeChatServer.Controllers {
  ...
  public class BookController : ControllerBase {
    ...
    #region Why we can't acess google?

    [HttpGet, Route("whyGoogle")]
    public ActionResult whyCannotGoogle() {
      string url = hostingEnvironment.WebRootPath + @"\Essays\whyCannotGoogle.zip";
